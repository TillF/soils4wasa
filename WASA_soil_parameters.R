# compute WASA-SED input (soil hydraulic properties) from granulometry using pedotransfer functions
# -----------------------------------------------------------------------

# requirements:
# - existing GRASS-GIS location of required extent
# - maps of granulometry in GRASSlocation (as generated by process_hwsd.R)
